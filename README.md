...
# create a `DemoActivity`, using a custom `DrawAdapter`
# transmit widget positions and texts to display during showcase to the `DemoActivity` from the `Activity` under showcase.
